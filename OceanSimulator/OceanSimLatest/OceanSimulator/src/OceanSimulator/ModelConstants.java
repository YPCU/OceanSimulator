...
public class ModelConstants {
    ...
    public static final double PLANKTON_CREATE_PROB = 0.7;
    //declearing the sardine generating probability 
    public static final double SARDINE_CREATE_PROB = 0.1;
    //declearing the shark generating probability 
    public static final double SHARK_CREATE_PROB = 0.05;

    //declearing the max age that plankton can live up to.
    public static final int PLANKTON_MAX_AGE = 100;
    //declearing the max age that sardine can live up to.
    public static final int SARDINE_MAX_AGE = 75;
    //declearing the max age that shark can live up to.
    public static final int SHARK_MAX_AGE = 150;
    ...
    public static final int SARDINE_BREEDING_AGE = 25;
    public static final int SHARK_BREEDING_AGE = 12;
